// src/domains/chat/components/message/MessageContact.tsx
...
function MessageContactInner({ contactName, contactPhone, isMine, onPress }: Props) {
  const T = useAppTheme();
...
export default memo(MessageContactInner);
